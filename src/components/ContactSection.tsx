      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-8 md:mb-16">
            <a href="mailto:faroukmanai@hotmail.fr" className="group flex items-center gap-2 md:gap-3 bg-gradient-primary text-primary-foreground px-5 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:opacity-90 transition-all hover:shadow-glow text-sm md:text-base">
