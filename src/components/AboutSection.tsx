const AboutSection = () => {
  ...
  return (
    <section id="apropos" className="py-32 relative overflow-hidden">
      {/* Background element */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6 text-muted-foreground">
              <p>
                Depuis plus de 5 ans, je conçois des expériences digitales qui 
                allient esthétique et fonctionnalité. Mon approche combine une 
                compréhension profonde des besoins utilisateurs avec une 
                sensibilité artistique unique.
              </p>
              <p>
